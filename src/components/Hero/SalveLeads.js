...
const btnReceberPropostaPc = document.querySelector('.btnReceberPropostaPc');

btnReceberPropostaPc.addEventListener('click', (event) => {
...
const btnReceberPropostaMob = document.querySelector('.btnReceberPropostaMob');

btnReceberPropostaMob.addEventListener('click', (event) => {
  event.preventDefault();
